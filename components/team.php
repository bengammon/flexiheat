<div id="team" class="layout layout--master layout--team">
    ...
    <div class="content content--team-2 rellax" data-rellax-percentage="0.5" data-rellax-xs-speed="-1" data-rellax-tablet-speed="-2" data-rellax-speed="-1">
        <div class="box box--behind box--behind-small box--behind-dark">
            <?php include("google-rating.php") ?>
        </div>
    </div>
